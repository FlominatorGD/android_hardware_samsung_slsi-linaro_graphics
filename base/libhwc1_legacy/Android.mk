...
COMMON_C_INCLUDES := \
    ...
    $(TOP)/hardware/samsung_slsi-linaro/graphics/base/libhwc1_legacy \
    $(TOP)/hardware/samsung_slsi-linaro/graphics/base/libhwc1_legacy/libhwcutils \
...
COMMON_C_INCLUDES += $(TOP)/hardware/samsung_slsi-linaro/graphics/base/libhwc1_legacy/libvppdisplay
else
COMMON_C_INCLUDES += $(TOP)/hardware/samsung_slsi-linaro/graphics/base/libhwc1_legacy/libdisplay
endif

ifeq ($(BOARD_HDMI_INCAPABLE), true)
COMMON_C_INCLUDES += $(TOP)/hardware/samsung_slsi-linaro/graphics/base/libhwc1_legacy/libhdmi_dummy
else ifeq ($(BOARD_HDMI_LEGACY), true)
COMMON_C_INCLUDES += $(TOP)/hardware/samsung_slsi-linaro/graphics/base/libhwc1_legacy/libhdmi_legacy
else
COMMON_C_INCLUDES += $(TOP)/hardware/samsung_slsi-linaro/graphics/base/libhwc1_legacy/libvpphdmi
endif

ifeq ($(BOARD_USES_VIRTUAL_DISPLAY), true)
ifeq ($(BOARD_USES_VPP), true)
COMMON_C_INCLUDES += \
    $(TOP)/hardware/samsung_slsi-linaro/graphics/base/libhwc1_legacy/libvppvirtualdisplay
else
COMMON_C_INCLUDES += \
    $(TOP)/hardware/samsung_slsi-linaro/graphics/base/libhwc1_legacy/libvirtualdisplay
endif
COMMON_C_INCLUDES += \
...
LOCAL_C_INCLUDES += $(TOP)/hardware/samsung_slsi-linaro/graphics/base/libhwc1_legacy/libvpphdmi

ifeq ($(BOARD_USES_HWC_SERVICES),true)
    LOCAL_C_INCLUDES += $(TOP)/hardware/samsung_slsi-linaro/graphics/base/libhwc1_legacy/libhwcService
endif
...
LOCAL_C_INCLUDES += $(TOP)/hardware/samsung_slsi-linaro/graphics/base/libhwc1_legacy/libhdmi_legacy
